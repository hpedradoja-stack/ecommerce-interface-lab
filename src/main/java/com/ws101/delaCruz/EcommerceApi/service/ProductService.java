...
public class ProductService {
    ...
    // 3. Constructor with sample data (at least 10 products)
    public ProductService() {
        ...
        productList.add(new Product(nextId++, "Phone", "Smartphone Android", 15000, "Electronics", 15, ""));
        ...
        productList.add(new Product(nextId++, "Bag", "School backpack", 900, "Accessories", 25, ""));
